...
<html lang="en">
	<head>
		...
		<script type = "text/javascript" src = "<?php echo SITE_PATH ?>module/shop/view/js/favorites.js"></script>
		<script type = "text/javascript" src = "<?php echo SITE_PATH ?>module/shop/model/controllerShop.js"></script>
	</head>
<body>
